...
<body>
      ...
      <div class="container ofirst">
        <div class="row">
            ...
            <div class="col-7 otext2">
                <div>
                    <h4>Outdoor plants offer a direct connection to the natural world, allowing us to immerse ourselves in its beauty and splendor. From towering trees to vibrant flowers, outdoor plants awaken our senses and remind us of our interconnectedness with the Earth, fostering a deeper appreciation for the environment and all its inhabitants.</h4>
                </div>
            </div>
        </div>
      </div>
    ...
    <section class="third container mt-5">
        <div class="all">
